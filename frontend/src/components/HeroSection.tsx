...
import SuperDhamakaOffer from './SuperDhamakaOffer';
  ...
  const heroSlides: HeroSlide[] = [
    {
      ...
      image: 'https://png.pngtree.com/thumb_back/fh260/background/20250705/pngtree-a-colorful-collection-of-sweaters-for-women-in-fall-season-image_17467122.webp',
      buttonText: 'Shop Now',
      buttonLink: '/products',
    ...
    },
    {
      ...
      image: 'https://img.freepik.com/premium-photo/colorful-clothing-rack-displaying-variety-casual-shirts-retail-store-setting_93675-362424.jpg?semt=ais_hybrid&w=740&q=80',
                  ...
                  <div className="relative container h-full flex items-center">
                    <div className="max-w-2xl space-y-4 md:space-y-6 animate-in fade-in slide-in-from-left duration-700">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span
                          className={`text-sm md:text-base font-semibold ${slide.textColor} uppercase tracking-wider`}
                        >
                          {slide.subtitle}
                        </span>
                      </div>
                      ...
                      {/* Title */}
                      <h1
                        className={`text-4xl md:text-6xl lg:text-7xl font-bold ${slide.textColor} leading-tight drop-shadow-lg`}
                      >
                        {slide.title}
                      </h1>
                      ...
                      {/* Description */}
                      <p
                        className={`text-lg md:text-xl ${slide.textColor} opacity-90 max-w-xl drop-shadow-md`}
                      >
                        {slide.description}
                      </p>
                      ...
                      <div className="flex flex-wrap gap-6 pt-6">
                        <div
                          className={`flex items-center gap-2 ${slide.textColor} opacity-90`}
                        >
