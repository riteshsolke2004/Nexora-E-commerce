...
const Tablets = () => {
  const brands = ['Apple', 'Samsung', 'iPad', 'Microsoft', 'Lenovo'];
  ...
  const products = Array.from({ length: 16 }, (_, i) => ({
    ...
    image: `https://images.unsplash.com/photo-1526241749133-3a1369fef974?w=500&h=500&fit=crop&q=${80 + i}`,
    ...
    <div className="min-h-screen bg-gradient-subtle">
      <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white py-12 mb-8">
        <div className="container">
          ...
          <p className="text-blue-100">Portable tablets for work and entertainment</p>
        </div>
      </div>
        ...
        <div>
          <div className="flex items-center justify-between mb-8">
            <h2 className="text-2xl font-bold">
              {selectedBrand ? `${selectedBrand} Tablets` : 'All Tablets'}
            </h2>
